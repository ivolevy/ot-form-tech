  ...
  return (
    <div className="space-y-8">
      ...
      <details className="group rounded-lg border border-gray-200 bg-white shadow-sm">
        <summary className="flex cursor-pointer items-center border-b border-gray-200 bg-gray-50 px-6 py-4 hover:bg-green-50">
          <div className="flex items-center justify-start w-full">
            <div className="h-8 w-1 rounded-full bg-green-500 mr-2"></div>
          ...
          <div className="flex items-center gap-3 ml-auto">
            <div className="rounded-full bg-green-50 px-4 py-1 text-sm font-medium text-green-700 min-w-[90px] flex justify-center whitespace-nowrap">
              {tribunasAgents} agentes
            </div>
            <div className="flex items-center gap-1 rounded-md bg-green-100 px-3 py-1 text-sm font-medium text-green-700 min-w-[80px] justify-center whitespace-nowrap">
      ...
      <details className="group rounded-lg border border-gray-200 bg-white shadow-sm">
        <summary className="flex cursor-pointer items-center border-b border-gray-200 bg-gray-50 px-6 py-4 hover:bg-blue-50">
          <div className="flex items-center justify-start w-full">
            <div className="h-8 w-1 rounded-full bg-blue-500 mr-2"></div>
            <div className="w-full text-left">
          ...
          <div className="flex items-center gap-3 ml-auto">
            <div className="rounded-full bg-blue-50 px-4 py-1 text-sm font-medium text-blue-700 min-w-[90px] flex justify-center whitespace-nowrap">
              {exteriorAgents} agentes
            </div>
            <div className="flex items-center gap-1 rounded-md bg-blue-100 px-3 py-1 text-sm font-medium text-blue-700 min-w-[80px] justify-center whitespace-nowrap">
              <span>ver detalle</span>
            </div>
          </div>
        </summary>
      ...
      <details className="group rounded-lg border border-gray-200 bg-white shadow-sm">
        <summary className="flex cursor-pointer items-center border-b border-gray-200 bg-gray-50 px-6 py-4 hover:bg-amber-50">
          <div className="flex items-center justify-start w-full">
            <div className="h-8 w-1 rounded-full bg-amber-500 mr-2"></div>
            <div className="w-full text-left">
          ...
          <div className="flex items-center gap-3 ml-auto">
            <div className="rounded-full bg-amber-50 px-4 py-1 text-sm font-medium text-amber-700 min-w-[90px] flex justify-center whitespace-nowrap">
              {internoAgents} agentes
            </div>
            <div className="flex items-center gap-1 rounded-md bg-amber-100 px-3 py-1 text-sm font-medium text-amber-700 min-w-[80px] justify-center whitespace-nowrap">
              <span>ver detalle</span>
            </div>
          </div>
        </summary>
